...
import { idlFactory } from './companyData.did.js';
export { idlFactory } from './companyData.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_COMPANYDATA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./companyData.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the companyData canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./companyData.did.js")._SERVICE>}
 */
export const companyData = createActor(canisterId);
