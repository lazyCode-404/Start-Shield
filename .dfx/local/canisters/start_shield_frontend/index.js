...
import { idlFactory } from './start_shield_frontend.did.js';
export { idlFactory } from './start_shield_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_START_SHIELD_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./start_shield_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the start_shield_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./start_shield_frontend.did.js")._SERVICE>}
 */
export const start_shield_frontend = createActor(canisterId);
