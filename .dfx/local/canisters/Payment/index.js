...
export const canisterId = process.env.CANISTER_ID_PAYMENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Payment.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Payment canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Payment.did.js")._SERVICE>}
 */
export const Payment = createActor(canisterId);
